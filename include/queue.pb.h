...
// int32 int32_value = 4;
inline bool QueueStorageNode::_internal_has_int32_value() const {
  return data_case() == kInt32Value;
}
inline bool QueueStorageNode::has_int32_value() const {
  return _internal_has_int32_value();
}
inline void QueueStorageNode::set_has_int32_value() {
  _impl_._oneof_case_[0] = kInt32Value;
}
inline void QueueStorageNode::clear_int32_value() {
  if (_internal_has_int32_value()) {
    _impl_.data_.int32_value_ = 0;
    clear_has_data();
  }
}
inline int32_t QueueStorageNode::_internal_int32_value() const {
  if (_internal_has_int32_value()) {
    return _impl_.data_.int32_value_;
  }
  return 0;
}
inline void QueueStorageNode::_internal_set_int32_value(int32_t value) {
  if (!_internal_has_int32_value()) {
    clear_data();
    set_has_int32_value();
  }
  _impl_.data_.int32_value_ = value;
}
inline int32_t QueueStorageNode::int32_value() const {
  // @@protoc_insertion_point(field_get:efesx.queue.detail.proto.QueueStorageNode.int32_value)
  return _internal_int32_value();
}
inline void QueueStorageNode::set_int32_value(int32_t value) {
  _internal_set_int32_value(value);
  // @@protoc_insertion_point(field_set:efesx.queue.detail.proto.QueueStorageNode.int32_value)
}

// int64 int64_value = 5;
inline bool QueueStorageNode::_internal_has_int64_value() const {
  return data_case() == kInt64Value;
}
inline bool QueueStorageNode::has_int64_value() const {
  return _internal_has_int64_value();
}
inline void QueueStorageNode::set_has_int64_value() {
  _impl_._oneof_case_[0] = kInt64Value;
}
inline void QueueStorageNode::clear_int64_value() {
  if (_internal_has_int64_value()) {
    _impl_.data_.int64_value_ = int64_t{0};
    clear_has_data();
  }
}
inline int64_t QueueStorageNode::_internal_int64_value() const {
  if (_internal_has_int64_value()) {
    return _impl_.data_.int64_value_;
  }
  return int64_t{0};
}
inline void QueueStorageNode::_internal_set_int64_value(int64_t value) {
  if (!_internal_has_int64_value()) {
    clear_data();
    set_has_int64_value();
  }
  _impl_.data_.int64_value_ = value;
}
inline int64_t QueueStorageNode::int64_value() const {
  // @@protoc_insertion_point(field_get:efesx.queue.detail.proto.QueueStorageNode.int64_value)
  return _internal_int64_value();
}
inline void QueueStorageNode::set_int64_value(int64_t value) {
  _internal_set_int64_value(value);
  // @@protoc_insertion_point(field_set:efesx.queue.detail.proto.QueueStorageNode.int64_value)
}
